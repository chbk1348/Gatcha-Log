plugins {
    ...
    // ─── Baseline Profile — :baselineprofile(생성, com.android.test) + :GL_Android(소비). release 핫패스 AOT. ───
    ...
    // ─── KMP(iOS) 마이그레이션용 — :GL_Shared 모듈 전용. :GL_Android 에는 영향 없음. ───
    ...
    // :GL_Shared 의 iOS 프레임워크 생성에만 관여(Android·:GL_Android 무영향). Kotlin 2.3.21 지원(0.10.12).
