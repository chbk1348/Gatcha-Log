...
object GameVersions {
    ...
    /**
     * 버전이 오는 게임 수 — 화면이 **스켈레톤 칸을 그만큼** 세운다.
     *
     * 값을 받아 보기 전에는 몇 칸이 설지 알 수 없는데, 화면에 숫자를 박아 두면 [gameOf] 에
     * 게임이 늘 때 스켈레톤만 옛 칸 수로 남는다(3 으로 박혀 있어 다섯 칸 자리에 셋만 섰다).
     */
    val trackedCount: Int get() = gameOf.size
